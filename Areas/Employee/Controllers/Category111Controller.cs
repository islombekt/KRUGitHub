...
namespace KRU.Areas.Employee.Controllers
{
    ...
    public class Category111Controller : Controller
    {
        ...
        // GET: Employee/Category111/Details/5
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var category111 = await _context.Category111s
                .Include(c => c.Category11).Include(u => u.FinanceReports).ThenInclude(u => u.Employee).ThenInclude(u => u.User).Include(u => u.FinanceReports).ThenInclude(u => u.Manager).ThenInclude(u => u.User)
        ...
        // GET: Employee/Category111/Create
        ...
        // POST: Employee/Category111/Create
        ...
        // GET: Employee/Category111/Edit/5
        ...
        // POST: Employee/Category111/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Employee/Category111/Delete/5
        ...
        // POST: Employee/Category111/Delete/5
