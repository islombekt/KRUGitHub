...
namespace KRU.Areas.Manager.Controllers
{
    ...
    public class Category11Controller : Controller
    {
        ...
        // GET: Manager/Category11/Details/5
        ...
        // POST: Manager/Category11/Create
        ...
        // POST: Manager/Category11/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Manager/Category11/Delete/5
        ...
        // POST: Manager/Category11/Delete/5
